...
$('#'+opts.boxId).bgiframe();}
$(this).each(function(i){$(this).unbind();$(this).keyup(function(e){var txtLength=$(this).val().replace(/[^\x00-\xff]/g,"rr").length/2;if(txtLength>opts.limit)
...
var charsRemaining=opts.limit-txtLength;var remText=opts.remTextFilter(opts,charsRemaining);var limitText=opts.limitTextFilter(opts);if(opts.limitTextShow)
...
$('#'+opts.boxId).html(remText).show();});$(this).keypress(function(e){var txtLength=$(this).val().replace(/[^\x00-\xff]/g,"rr").length/2;if((!e.keyCode||(e.keyCode>46&&e.keyCode<90))&&txtLength>=opts.limit)
